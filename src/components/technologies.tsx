					...
					<div className="flex flex-col lg:flex-row items-center gap-8">
						<div className="flex-1">
							...
							<p className="text-muted-foreground leading-relaxed mb-4">
								Nossa equipe é formada por desenvolvedores certificados e
								especializados em React, com experiência comprovada em projetos
								de grande escala para empresas nacionais e internacionais.
							</p>
							<p className="text-muted-foreground leading-relaxed">
								Mantemos-nos sempre atualizados com as últimas tendências e
								melhores práticas do ecossistema React, garantindo que seu
								projeto utilize as tecnologias mais adequadas e modernas.
							</p>
						</div>
